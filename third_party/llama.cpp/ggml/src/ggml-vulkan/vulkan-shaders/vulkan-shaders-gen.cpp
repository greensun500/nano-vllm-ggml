...
void process_shaders() {
    ...
    string_to_spv("paged_attn_f32", "paged_attn.comp", {});
    ...
    string_to_spv("mul_mat_vec_q6_k_argmax", "mul_mat_vec_q6_k_argmax.comp",
        merge_maps(base_dict, {{"DATA_A_Q6_K", "1"}}));
    string_to_spv("q6_k_argmax_reduce", "q6_k_argmax_reduce.comp", {});
